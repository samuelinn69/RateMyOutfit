...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await register(form);
      toast.success('Account created! Time to slay. 🔥');
      ...
      <div className="w-full max-w-4xl relative z-10 grid md:grid-cols-2 gap-12 items-center py-12">
        ...
        >
          ...
          <h1 className="text-5xl font-black text-white mb-4 leading-tight">
            Know your
            <br />
            <span className="gradient-text">style score.</span>
          </h1>
          <p className="text-white/40 text-lg mb-8">
            Join 10,000+ fashion-conscious people getting honest AI feedback on their outfits.
          </p>
